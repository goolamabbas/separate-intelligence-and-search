...
md.use({renderer:{
 ...
 link({href,tokens}) {if(href==='README.md') href=base+'guide/'; else if(/^choosing-providers\.md(?:#.*)?$/.test(href)) href=base+'guide/choosing-providers/'+(href.includes('#')?href.slice(href.indexOf('#')):''); else if(/^connecting-providers\.md(?:#.*)?$/.test(href)) href=base+'guide/connecting-providers/'+(href.includes('#')?href.slice(href.indexOf('#')):''); return `<a href="${esc(href)}">${this.parser.parseInline(tokens)}</a>`;},
...
const nav=`<a href="${base}guide/">Overview</a><a href="${base}guide/choosing-providers/">Choosing providers ↗</a><a href="${base}guide/connecting-providers/">Connecting providers ↗</a><a class="selected" href="#main" aria-current="page">Research prompts <span>Reading now</span></a>`;
